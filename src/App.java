...
{
    javax.swing.JPanel header_panel, center_panel, footer_panel;
    
    javax.swing.JLabel title_label, subtitle_label;
    ...
    */
    ...
    App(boolean isActive)
    {
        ...
        this.setTitle("https://github.com/MayankDevil/");
            ...
            //center_panel.setLayout(null);
                ...
                validate_button = new javax.swing.JButton("Check");
    ...
    /*
        --------------------------------------------------------------------------
        | myFont function argument font style or size AND return new font object |
        --------------------------------------------------------------------------
    */
